...
def kurtosis(r):
    ...
    Kurtosis > 3 is called leptokurtic. Fatter tails, undesirable for investors.
    """
    demeaned_r = r - r.mean()
...
def annualize_rets(r, periods_per_year):
    ...
    compounded_growth is a holding period return (or Total Return) + 1
    """
...
def annualize_vol(r, periods_per_year):
    ...
    periods_per_year is the number of data points per year (days = 252, weeks = 52, months = 12)
    """
...
def var_historic(r, level=5):
    ...
    For reporting purpose - the sign is inverted. 
    Positive number represents the LOSS (amount at Risk)
    """
    if isinstance(r, pd.DataFrame):
...
def bond_cash_flows(maturity, principal=100, coupon_rate=0.03, coupons_per_year=12):
    ...
    -Principal - also known as face value of the bond
    -coupon_rate - Yearly rate. Every period, bond pays: Principal * coupon_rate / coupons_per_year
    -coupons_per_year - number of payments per year.
    """
...
def match_durations(cf_t, cf_s, cf_l, discount_rate):
    ...
    cf_t - cash flow of target
    cf_s - cash flow of short bond
    cf_l - cash flow of long bond
    """
